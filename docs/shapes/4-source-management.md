...
On 2026-08-17, the user selected **A — Source Directory + Detail Ledger**, confirmed that editing source endpoint or credential details must **Save and refresh immediately**, and explicitly approved the recorded 1265×713 first viewport after the quiet outlined **Add source** action was added. This brief is Confirmed and visible implementation may proceed within its boundaries.
